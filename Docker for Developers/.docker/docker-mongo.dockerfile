...
# To build:
# docker build -f docker-mongo.dockerfile --tag btree/mongo ../
# docker build -f docker-mongo.dockerfile --tag btree/dfd-mongo ../

# To run the image (add -d if you want it to run in the background)
# docker run -p 27017:27017 --env-file .docker/mongo.development.env -d --name mongo btree/mongo
# docker run -p 27017:27017 --env-file .docker/mongo.development.env -d --name mongo btree/dfd-mongo
